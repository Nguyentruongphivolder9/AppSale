...
public class SignUpViewModel extends ViewModel {
    ...
    public void register(String email, String name, String phone, String address ,String password){
        userData.setValue(new AppResource.Loading(null));
        Call<AppResource<User>> callLogin = repository.register(email, name, phone, address, password);
